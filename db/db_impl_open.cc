...
Status DBImpl::WriteLevel0TableForRecovery(int job_id, ColumnFamilyData* cfd,
  ...
  //std::cout<<"### db_impl_open"<<std::endl;
  // dump timestamp  
  sys_time<microseconds> l0recover_start_time{microseconds(start_micros)};
  std::ofstream ofile;
  ofile.open("/tmp/l0recover_job_timestamps.csv",std::ios::app); // open file for appending
  ofile<<"l0recover_start_timestamp, "<<l0recover_start_time<< ", micros_stamp, "<<start_micros<<", duration_usec, "<<stats.micros<<"\n";
